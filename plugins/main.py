...
from books_mongodb_script   import sync_books_threaded              as google_upsert_books
...
if __name__ == "__main__":
    try:
        ...
        thread_books =  threading.Thread(target=google_upsert_books, kwargs={"parts": 10, "max_books_per_query": 500})
